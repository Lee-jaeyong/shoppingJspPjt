	...
	function inputCheck(){
		if(!userNameCheck.test($("#inputName").val())){
			...
			if($("#inputEmail").val()=="")
				...
				$("#emailMsg").text("이메일 형식으로 입력해주세요.");
			$("#inputEmail").focus();
		} else if($("#inputPh2").val()==""||$("#inputPh3").val()==""||$("#inputPh2").val().length < 3||$("#inputPh3").val().length<4){
			...
			if($("#inputSex").val() == "")
				...
				$("#sexMsg").text("다시 확인해 주세요.");
			$("#inputSex").focus();
		} else if($("#inputAddress").val() == ""||$("#detailAddress").val() ==""){
			$("#addressMsg").text("주소를 입력해 주세요");
			$("#detailAddress").focus();
		} else{
			$("#joinForm").attr("action","joinSubmit.do").attr("method","post").submit();
...
%>
	<input type="hidden" value="<%=checkNum %>" id="joinReCheck"><!-- 회원가입 오류체크 -->
	<div class="site-wrap">
							...
							<div class="form-group row">
								<div class="col-md-4">
									<label for="c_companyname" class="text-black">전화번호<span
										class="text-danger">*</span></label> <select id="inputPh1" name="inputPh1"
										class="form-control">
								...
								<div class="col-md-4">
									<label for="c_fname" class="text-black">&nbsp;</label> <input
										type="text" class="form-control" id="inputPh2" name="inputPh2"
										maxlength="4">
								</div>
								<div class="col-md-4">
									<label for="c_fname" class="text-black">&nbsp;</label> <input
										type="text" class="form-control" id="inputPh3" name="inputPh3"
										maxlength="4">
								</div>
									...
									<div class="row">
										<div class="col-md-2">
											<input type="button" class="btn btn-primary btn-lg btn-block"
												id="searchAddress" name="searchAddress" value="주소찾기" />
										</div>
										<div class="col-md-10">
											<input type="text" class="form-control" id="inputAddress"
												name="inputAddress" disabled="false" placeholder="주소">
										</div>
									</div>
								</div>
							</div>
